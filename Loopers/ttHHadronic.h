...
// makeCMS3ClassFiles("/home/users/sjmay/ttH/Loopers/merged_babies/ST_FCNC-TH_Tleptonic_HToaa_eta_hct-MadGraph5-pythia8_RunIIFall17MiniAODv2-PU2017_12Apr2018_tauDecays_94X_mc2017_realistic_v14-v1_MINIAODSIM_microAOD_v1.2_29May2020_ttH_Babies_RunIIv5.7/merged_ntuple_1.root", "tagsDumper/trees/_13TeV_TTHHadronicTag", "ttHHadronic", "tas", "cms3")
...
class ttHHadronic {
 ...
 protected: 
  ...
  float    PixelSeedWeightUp01sigma_;
  TBranch *PixelSeedWeightUp01sigma_branch;
  bool     PixelSeedWeightUp01sigma_isLoaded;
  float    sublead_Mad_;
  ...
  float    sigmaRV_;
  TBranch *sigmaRV_branch;
  bool     sigmaRV_isLoaded;
  ...
  float    PixelSeedWeightDown01sigma_;
  TBranch *PixelSeedWeightDown01sigma_branch;
  bool     PixelSeedWeightDown01sigma_isLoaded;
  float    nGoodTaus_;
...
void LoadAllBranches(); 
  ...
  const float &PixelSeedWeightUp01sigma();
  ...
  const float &PixelSeedWeightDown01sigma();
