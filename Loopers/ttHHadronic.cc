...
void ttHHadronic::Init(TTree *tree) {
  ...
  PixelSeedWeightUp01sigma_branch = tree->GetBranch("PixelSeedWeightUp01sigma");
  if (PixelSeedWeightUp01sigma_branch) PixelSeedWeightUp01sigma_branch->SetAddress(&PixelSeedWeightUp01sigma_);
  ...
  sigmaRV_branch = tree->GetBranch("sigmaRV");
  if (sigmaRV_branch) sigmaRV_branch->SetAddress(&sigmaRV_);
  ...
  PixelSeedWeightDown01sigma_branch = tree->GetBranch("PixelSeedWeightDown01sigma");
  if (PixelSeedWeightDown01sigma_branch) PixelSeedWeightDown01sigma_branch->SetAddress(&PixelSeedWeightDown01sigma_);
...
void ttHHadronic::GetEntry(unsigned int idx) {
  ...
  PixelSeedWeightUp01sigma_isLoaded = false;
  ...
  PixelSeedWeightDown01sigma_isLoaded = false;
...
void ttHHadronic::LoadAllBranches() {
  ...
  if (PixelSeedWeightUp01sigma_branch != 0) PixelSeedWeightUp01sigma();
  ...
  if (PixelSeedWeightDown01sigma_branch != 0) PixelSeedWeightDown01sigma();
...
const float &ttHHadronic::PixelSeedWeightUp01sigma() {
  if (not PixelSeedWeightUp01sigma_isLoaded) {
    if (PixelSeedWeightUp01sigma_branch != 0) {
      PixelSeedWeightUp01sigma_branch->GetEntry(index);
    } else {
      printf("branch PixelSeedWeightUp01sigma_branch does not exist!\n");
      exit(1);
    }
    PixelSeedWeightUp01sigma_isLoaded = true;
  }
  return PixelSeedWeightUp01sigma_;
}
...
const float &ttHHadronic::sigmaRV() {
  if (not sigmaRV_isLoaded) {
    if (sigmaRV_branch != 0) {
      sigmaRV_branch->GetEntry(index);
    } else {
      printf("branch sigmaRV_branch does not exist!\n");
      exit(1);
    }
    sigmaRV_isLoaded = true;
  }
  return sigmaRV_;
}
...
const float &ttHHadronic::PixelSeedWeightDown01sigma() {
  if (not PixelSeedWeightDown01sigma_isLoaded) {
    if (PixelSeedWeightDown01sigma_branch != 0) {
      PixelSeedWeightDown01sigma_branch->GetEntry(index);
    } else {
      printf("branch PixelSeedWeightDown01sigma_branch does not exist!\n");
      exit(1);
    }
    PixelSeedWeightDown01sigma_isLoaded = true;
  }
  return PixelSeedWeightDown01sigma_;
}
...
const float &PixelSeedWeightUp01sigma() { return cms3.PixelSeedWeightUp01sigma(); }
...
const float &sigmaRV() { return cms3.sigmaRV(); }
...
const float &PixelSeedWeightDown01sigma() { return cms3.PixelSeedWeightDown01sigma(); }
